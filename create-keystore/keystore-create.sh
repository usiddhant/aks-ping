...
[ -z "$KEYSTORE_CONF_DIR" ] && KEYSTORE_CONF_DIR=/Users/siddhantupadhyay/Developer/ForgeOps/aks-ping/create-keystore
[ -z "$KEYSTORE_CONF" ] && KEYSTORE_CONF=$KEYSTORE_CONF_DIR/keystore.json
[ -z "$KEYSTORE_TYPE" ] && KEYSTORE_TYPE=$(jq -r .storeType $KEYSTORE_CONF)
[ -z "$KEYSTORE_DIR" ] && KEYSTORE_DIR=/Users/siddhantupadhyay/Developer/ForgeOps/aks-ping/create-keystore/keystore
[ -z "$KEYSTORE" ] && KEYSTORE=$KEYSTORE_DIR/keystore.$KEYSTORE_TYPE

[ -z "$SECRETS_DIR" ] && SECRETS_DIR=/Users/siddhantupadhyay/Developer/ForgeOps/aks-ping/create-keystore/secrets
